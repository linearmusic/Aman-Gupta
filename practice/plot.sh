...
# Step 8: Plot the locations from location.dat as blue crosses.
# We are plotting each point individually to debug the file reading issue.
echo "87.09 27.99" | gmt psxy $Reg $Pro -Sx0.2i -W1.5p,blue -O -K >> $ps
echo "87.35 27.62" | gmt psxy $Reg $Pro -Sx0.2i -W1.5p,blue -O -K >> $ps
echo "85.72 27.73" | gmt psxy $Reg $Pro -Sx0.2i -W1.5p,blue -O >> $ps
